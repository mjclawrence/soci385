...
library(tidyverse)
library(pander)
gss_week11 <- read.csv("https://raw.githubusercontent.com/mjclawrence/soci385/master/data/gss_week_11.csv")
```
...
gss_week11$degree <- factor(gss_week11$degree, 
                     levels = c("Less Than HS", "HS Diploma",
                              ...
                              "Grad/Prof Degree"))
gss_week11$degree <- relevel(gss_week11$degree, ref = "College Degree")
...
```{r}
gss_week11$religion <- relevel(gss_week11$religion, ref = "Protestant")
...
*Lots of code here; looking at the plot is more important than mastering the code!*
