...
> This class is called `r coursename` and it is SOAN `r coursenumber`.
...
hurricanes <- read.csv("https://raw.githubusercontent.com/mjclawrence/soci385/f19/data/hurricanes.csv")
```
